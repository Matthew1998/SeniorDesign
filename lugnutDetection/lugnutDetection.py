...
MODEL_PATH = '/home/seniordesign/TensorFlow/CompletedModels/lugnut/'
IMAGE_PATH = '/home/seniordesign/Desktop/SeniorDesign/lugnutDetection/images/'

# Path to frozen detection graph. This is the actual model that is used for the object detection.
CKPT_PATH = MODEL_PATH + 'frozen_inference_graph.pb'

# List of the strings that is used to add correct label for each box.
LABEL_PATH = MODEL_PATH + 'object-detection.pbtxt'
...
with detection_graph.as_default():
    with tf.compat.v1.Session(graph=detection_graph) as sess:
        while True:
            ...
            image_np = cv2.imread('images/IMG_14' + str(tens) + str(ones) + '.jpg')
